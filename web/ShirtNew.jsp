...
<div id="wrapper">
    ...
    <div class="container">
        <div class="row karl-new-arrivals">
            ...
            <%
                ArrayList<Cloth> clothList = (ArrayList) request.getAttribute("clothList");
            %>
            ...
            <div class="col-12 col-sm-6 col-md-4 single_gallery_item women wow fadeInUpBig" data-wow-delay="0.2s">
                ...
                <div class="product-img">
                    <img src="${pageContext.request.contextPath}/img/product-img/<%=clothList.get(i).getClothImagePath()%>" alt="">
                ...
                <div class="product-description">
                    <h4 class="product-price">Rs.<%=clothList.get(i).getClothPrice()%>0</h4>
                    <p><%=clothList.get(i).getClothName()%></p>
                    <!-- Add to Cart -->

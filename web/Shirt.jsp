                    ...
                    <div class="row h-100 align-items-center justify-content-end">
                        ...
                        <div class="col-12 col-lg-7">
                            <div class="top_single_area d-flex align-items-center">
                                <!-- Logo Area -->
                                <div class="top_logo">
                                    <a href="#"><img src="${pageContext.request.contextPath}/img/core-img/3.png" alt=""></a>
                                </div>
                                <!-- Cart & Menu Area -->
                                <div class="header-cart-menu d-flex align-items-center ml-auto">
                                    ...
                                    <div class="cart">
                                        ...
                                        <ul class="cart-list">
                                            <li>
                                                <a href="#" class="image"><img src="${pageContext.request.contextPath}/img/product-img/product-10.jpg" class="cart-thumb" alt=""></a>
                                            ...
                                            <li>
                                                <a href="#" class="image"><img src="${pageContext.request.contextPath}/img/product-img/product-11.jpg" class="cart-thumb" alt=""></a>
                                                <div class="cart-item-desc">
                                                    <h6><a href="#">Women's Fashion</a></h6>
                                                    <p>1x - <span class="price">$10</span></p>
                                                </div>
                ...
                <div class="container h-100">
                    <div class="row h-100">
                        <div class="col-12 d-md-flex justify-content-between">
                                    ...
                                    <div class="collapse navbar-collapse align-items-start collapse" id="karl-navbar">
                                        <ul class="navbar-nav animated" id="nav">
											 ...
											 <li class="nav-item dropdown">
                                                <a class="nav-link dropdown-toggle" href="#" id="karlDropdown1" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">MEN</a>
                                                <div class="dropdown-menu" aria-labelledby="karlDropdown">
													<a class="dropdown-item" href="Shirt.jsp">Shirt</a>
                                                    <a class="dropdown-item" href="T-shirt.jsp">T-shirt</a>
                                                    <a class="dropdown-item" href="Gent_Trouser.jsp">Gent Trouser</a>
                                                    
                                                </div>
                                            </li>
                                            <li class="nav-item dropdown">
                                                <a class="nav-link dropdown-toggle" href="#" id="karlDropdown2" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">WOMEN</a>
                                                <div class="dropdown-menu" aria-labelledby="karlDropdown">
													...
													<a class="dropdown-item" href="Lady_Trouser.jsp">Lady Trouser</a>
                                                </div>
                                            </li>
                                            <li class="nav-item"><a class="nav-link" href="#">SALES AND OFFERS</a></li>
                            ...
                            <!-- Help Line -->
                            <div class="help-line">
                                <a href="tel:+346573556778"><i class="ti-headphone-alt"></i> +11 657 5658</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row karl-new-arrivals">
                    ...
                    <div class="col-12 col-sm-6 col-md-4 single_gallery_item women wow fadeInUpBig" data-wow-delay="0.2s">
                        ...
                        <div class="product-img">
                            <img src="${pageContext.request.contextPath}/img/product-img/gentshirt2.jpg" alt="">
                        ...
                        <div class="product-description">
                            <h4 class="product-price">Rs. 2200.00</h4>
                            <p>Long Sleeved Normal Collar Shirt</p>
                            <!-- Add to Cart -->
                    ...
                    <div class="col-12 col-sm-6 col-md-4 single_gallery_item women wow fadeInUpBig" data-wow-delay="0.3s">
                        <!-- Product Image -->
                        <div class="product-img">
                            <img src="${pageContext.request.contextPath}/img/product-img/shirt1.jpg" alt="">
                            <div class="product-quicview">
                                <a href="#" data-toggle="modal" data-target="#quickview"><i class="ti-plus"></i></a>
                            </div>
                        </div>
                        <!-- Product Description -->
                        <div class="product-description">
                            <h4 class="product-price">Rs. 2100.00</h4>
                            <p>Chinese Collar Linen Shirt</p>
                            <!-- Add to Cart -->
                            <a href="#" class="add-to-cart-btn">ADD TO CART</a>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-sm-6 col-md-4 single_gallery_item shoes wow fadeInUpBig" data-wow-delay="0.5s">
                        <!-- Product Image -->
                        <div class="product-img">
                            <img src="${pageContext.request.contextPath}/img/product-img/shirt4.jpg" alt="">
                            <div class="product-quicview">
                                <a href="#" data-toggle="modal" data-target="#quickview"><i class="ti-plus"></i></a>
                            </div>
                        </div>
                        <!-- Product Description -->
                        <div class="product-description">
                            <h4 class="product-price">Rs. 2300.00</h4>
                            <p>Pink Chinese Collar Shirt</p>
                            <!-- Add to Cart -->
                            <a href="#" class="add-to-cart-btn">ADD TO CART</a>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-sm-6 col-md-4 single_gallery_item access wow fadeInUpBig" data-wow-delay="0.4s">
                        <!-- Product Image -->
                        <div class="product-img">
                            <img src="${pageContext.request.contextPath}/img/product-img/nshrt3.jpg" alt="">
                            <div class="product-quicview">
                                <a href="#" data-toggle="modal" data-target="#quickview"><i class="ti-plus"></i></a>
                            </div>
                        </div>
                        <!-- Product Description -->
                        <div class="product-description">
                            <h4 class="product-price">Rs. 2000.00</h4>
                            <p>Short Sleeved Cotton Shirt</p>
                            <!-- Add to Cart -->
                            <a href="#" class="add-to-cart-btn">ADD TO CART</a>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-sm-6 col-md-4 single_gallery_item women wow fadeInUpBig" data-wow-delay="0.6s">
                        <!-- Product Image -->
                        <div class="product-img">
                            <img src="${pageContext.request.contextPath}/img/product-img/nshrt5.jpg" alt="">
                            <div class="product-quicview">
                                <a href="#" data-toggle="modal" data-target="#quickview"><i class="ti-plus"></i></a>
                            </div>
                        </div>
                        <!-- Product Description -->
                        <div class="product-description">
                            <h4 class="product-price">Rs. 1900.00</h4>
                            <p>Normal Collar White Shirt</p>
                            <!-- Add to Cart -->
                            <a href="#" class="add-to-cart-btn">ADD TO CART</a>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-sm-6 col-md-4 single_gallery_item kids man wow fadeInUpBig" data-wow-delay="0.7s">
                        <!-- Product Image -->
                        <div class="product-img">
                            <img src="${pageContext.request.contextPath}/img/product-img/nshrt6.jpg" alt="">
                            <div class="product-quicview">
                                <a href="#" data-toggle="modal" data-target="#quickview"><i class="ti-plus"></i></a>
                            </div>
                        </div>
                        <!-- Product Description -->
                        <div class="product-description">
                            <h4 class="product-price">Rs. 1800.00</h4>
                            <p>Long Sleeved Navy Blue Shirt</p>
                            <!-- Add to Cart -->
                            <a href="#" class="add-to-cart-btn">ADD TO CART</a>
                        </div>
                    </div>
